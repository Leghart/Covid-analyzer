...
from exceptions import CollectDataException
...
def format_number(string):
    ...
    """
    return " ".join(dgt for dgt in textwrap.wrap(str(string)[::-1], 3))[::-1]
...
class DailyReport:
    ...
    def get_actual_data(self, country="Poland"):
        ...
        try:
            ...
            self.fatality_ratio = round(
                self.total_deaths / self.total_cases * 100,
                2,
            )
